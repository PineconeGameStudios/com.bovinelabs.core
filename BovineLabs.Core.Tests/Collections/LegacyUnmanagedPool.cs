// <copyright file="LegacyUnmanagedPool.cs" company="BovineLabs">
...
namespace BovineLabs.Core.Tests.Collections
{
    ...
    internal readonly unsafe struct LegacyUnmanagedPool<T> : IDisposable
        where T : unmanaged
    {
        ...
        public LegacyUnmanagedPool(int capacity, Allocator allocator = Allocator.Persistent)
        {
