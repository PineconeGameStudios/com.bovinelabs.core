// <copyright file="BurstManagedCallWrapper.cs" company="BovineLabs">
...
namespace BovineLabs.Core.Utility
{
    ...
    /// <summary>
    /// Packs managed callback arguments into a single pointer + size payload so the same
    /// unmanaged wrapper can dispatch any signature.
    /// </summary>
    public unsafe readonly struct BurstManagedCallWrapper
    {
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate void WrapperDelegate(void* managedFunctionPtr, void* argumentsPtr, int argumentsSize);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void ManagedDelegate(void* argumentsPtr, int argumentsSize);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BurstManagedCallWrapper"/> struct.
        /// </summary>
        /// <param name="managedFunctionPtr">
        /// Callback with a single payload pointer and payload size.
        /// </param>
        public BurstManagedCallWrapper(delegate*<void*, int, void> managedFunctionPtr)
        {
            Initialize();
